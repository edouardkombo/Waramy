...
CREATE TABLE /*!32312 IF NOT EXISTS*/ `cities` (
  `ID` int(11) NOT NULL,
  `Name` char(35) NOT NULL default '',
  `CountryCode` char(3) NOT NULL default '',
  `District` char(20) NOT NULL default '',
  `Population` int(11) NOT NULL default '0',
  UNIQUE KEY `city_ix` (`ID`)
...
INSERT INTO `cities` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES (1,'Kabul','AFG','Kabol',1790000),
	...
	(61,'South Hill','AIA',_latin1 0x96,961),
	(62,'The Valley','AIA',_latin1 0x96,595),
	...
	(127,'Gjumri','ARM',_latin1 0x8A6972616B,211700),
	(128,'Vanadzor','ARM','Lori',172700),
	(129,'Oranjestad','ABW',_latin1 0x96,29034),
	...
	(175,'Antwerpen','NLD','Antwerpen',446525),
	...
	(459,'Liverpool','GBR','England',462000),
	...
	(506,'Rotherrham','GBR','England',121380),
	...
	(536,'Douglas','GBR',_latin1 0x96,23487),
	...
	(548,_latin1 0x8A756D656E,'BGR','Varna',94686),
	...
	(908,'Batumi','GEO',_latin1 0x41647A61726961205B41749A6172615D,137700),
	...
	(915,'Gibraltar','GIB',_latin1 0x96,27025),
	...
	(920,'Tamuning','GUM',_latin1 0x96,9500),
	(921,'Agaña','GUM',_latin1 0x96,1139),
	...
	(1791,'Flying Fish Cove','CXR',_latin1 0x96,700),
	(1792,'Beograd','YUG','Central Serbia',1204000),
	(1793,'Novi Sad','YUG','Vojvodina',179626),
	(1794,_latin1 0x4E699A,'YUG','Central Serbia',175391),
	(1795,_latin1 0x5072699A74696E61,'YUG','Kosovo and Metohija',155496),
	...
	(1917,_latin1 0x5572756D749A69205BDC72FC6D71695D,'CHN','Xinxiang',1310100),
	...
	(2450,_latin1 0x8A6961756C696169,'LTU',_latin1 0x8A6961756C696169,146563),
	...
	(2694,'Monte-Carlo','MCO',_latin1 0x96,13154),
	(2695,'Monaco-Ville','MCO',_latin1 0x96,1234),
	...
	(2727,'Yangor','NRU',_latin1 0x96,4050),
	(2728,'Yaren','NRU',_latin1 0x96,559),
	...
	(2805,'Alofi','NIU',_latin1 0x96,682),
	(2806,'Kingston','NFK',_latin1 0x96,800),
	...
	(2912,'Adamstown','PCN',_latin1 0x96,42),
	...
	(3208,'Singapore','SGP',_latin1 0x96,4017733),
	(3209,'Bratislava','SVK','Bratislava',448292),
	(3210,_latin1 0x4B6F9A696365,'SVK','Východné Slovensko',241874),
	(3211,_latin1 0x5072659A6F76,'SVK','Východné Slovensko',93977),
	...
	(3443,_latin1 0x549A65726E69676976,'UKR',_latin1 0x549A65726E69676976,313000),
	(3444,_latin1 0x549A65726B617379,'UKR',_latin1 0x549A65726B617379,309000),
	...
	(3451,_latin1 0x549A65726E6976747369,'UKR',_latin1 0x549A65726E6976747369,259000),
	(3452,'Rivne','UKR','Rivne',245000),
	(3453,_latin1 0x4B72656D656E749A756B,'UKR','Pultava',239000),
	...
	(3460,_latin1 0x4B6572749A,'UKR','Krim',162000),
	...
	(3467,_latin1 0x416C749A6576736B,'UKR','Lugansk',119000),
	(3468,_latin1 0x4C797379749A616E736B,'UKR','Lugansk',116000),
	(3469,'Jevpatorija','UKR','Krim',112000),
	(3470,'Kamjanets-Podilskyi','UKR','Hmelnytskyi',109000),
	(3471,'Jenakijeve','UKR','Donetsk',105000),
	(3472,_latin1 0x4B7261736E7969204C75749A,'UKR','Lugansk',101000),
	...
	(3477,_latin1 0x4265726479749A6976,'UKR','Zytomyr',90000),
	(3478,'Izmajil','UKR','Odesa',90000),
	(3479,_latin1 0x8A6F73746B61,'UKR','Sumy',90000),
	(3480,'Uman','UKR',_latin1 0x549A65726B617379,90000),
	(3481,'Brovary','UKR','Kiova',89000),
	(3482,_latin1 0x4D756B61749A657665,'UKR','Taka-Karpatia',89000),
	...
	(3493,'Nouméa','NCL',_latin1 0x96,76293),
	...
	(3588,'Ufa','RUS',_latin1 0x42619A6B6F72746F7374616E,1091200),
	(3589,_latin1 0x549A656C6A6162696E736B,'RUS',_latin1 0x549A656C6A6162696E736B,1083200),
	...
	(3610,_latin1 0x4E61626572657A6E796A6520549A656C6E79,'RUS','Tatarstan',514700),
	...
	(3618,_latin1 0x549A65626F6B73617279,'RUS',_latin1 0x549A75766173736961,459200),
	(3619,'Brjansk','RUS','Brjansk',457400),
	(3620,'Tver','RUS','Tver',454900),
	(3621,'Kursk','RUS','Kursk',443500),
	(3622,'Magnitogorsk','RUS',_latin1 0x549A656C6A6162696E736B,427900),
	...
	(3629,_latin1 0x536F749A69,'RUS','Krasnodar',358600),
	...
	(3636,_latin1 0x4D616861749A6B616C61,'RUS','Dagestan',332800),
	(3637,_latin1 0x549A657265706F76657473,'RUS','Vologda',324400),
	(3638,'Saransk','RUS','Mordva',314800),
	(3639,'Tambov','RUS','Tambov',312000),
	(3640,'Vladikavkaz','RUS','North Ossetia-Alania',310100),
	(3641,_latin1 0x549A697461,'RUS',_latin1 0x549A697461,309900),
	...
	(3653,'Sterlitamak','RUS',_latin1 0x42619A6B6F72746F7374616E,265200),
	(3654,'Angarsk','RUS','Irkutsk',264700),
	(3655,_latin1 0x4A6F9A6B61722D4F6C61,'RUS','Marinmaa',249200),
	(3656,'Rybinsk','RUS','Jaroslavl',239600),
	(3657,'Prokopjevsk','RUS','Kemerovo',237300),
	(3658,'Niznevartovsk','RUS','Hanti-Mansia',233900),
	(3659,_latin1 0x4E616C749A696B,'RUS','Kabardi-Balkaria',233400),
	...
	(3664,_latin1 0x426C61676F76659A749A656E736B,'RUS','Amur',222000),
	(3665,_latin1 0x8A61687479,'RUS','Rostov-na-Donu',221800),
	...
	(3671,'Zlatoust','RUS',_latin1 0x549A656C6A6162696E736B,196900),
	(3672,'Jakutsk','RUS','Saha (Jakutia)',195400),
	(3673,'Podolsk','RUS','Moskova',194300),
	(3674,_latin1 0x506574726F7061766C6F76736B2D4B616D749A6174736B69,'RUS',_latin1 0x4B616D749A61746B61,194100),
	(3675,'Kamensk-Uralski','RUS','Sverdlovsk',190600),
	(3676,'Engels','RUS','Saratov',189000),
	(3677,'Syzran','RUS','Samara',186900),
	(3678,'Grozny','RUS',_latin1 0x549A65749A656E6961,186000),
	(3679,_latin1 0x4E6F766F749A65726B6173736B,'RUS','Rostov-na-Donu',184400),
	...
	(3685,'Miass','RUS',_latin1 0x549A656C6A6162696E736B,166200),
	...
	(3692,'Salavat','RUS',_latin1 0x42619A6B6F72746F7374616E,156800),
	(3693,_latin1 0x4D7974699A749A69,'RUS','Moskova',155700),
	...
	(3704,_latin1 0x42616C619A696861,'RUS','Moskova',132900),
	...
	(3711,_latin1 0x4B616D799A696E,'RUS','Volgograd',124600),
	(3712,_latin1 0x4E6F766F749A65626F6B736172736B,'RUS',_latin1 0x549A75766173736961,123400),
	(3713,_latin1 0x549A65726B6573736B,'RUS',_latin1 0x4B617261749A61692D549A65726B6573736961,121700),
	(3714,_latin1 0x41749A696E736B,'RUS','Krasnojarsk',121600),
	(3715,'Magadan','RUS','Magadan',121000),
	(3716,_latin1 0x4D69749A7572696E736B,'RUS','Tambov',120700),
	...
	(3722,_latin1 0x4E6F766F6B756962799A6576736B,'RUS','Samara',116200),
	(3723,'Neftekamsk','RUS',_latin1 0x42619A6B6F72746F7374616E,115700),
	(3724,'Leninsk-Kuznetski','RUS','Kemerovo',113800),
	(3725,'Oktjabrski','RUS',_latin1 0x42619A6B6F72746F7374616E,111500),
	...
	(3736,_latin1 0x8A749A6F6C6B6F766F,'RUS','Moskova',104900),
	(3737,_latin1 0x4D657A64757265749A656E736B,'RUS','Kemerovo',104400),
	(3738,'Usolje-Sibirskoje','RUS','Irkutsk',103500),
	(3739,'Elista','RUS','Kalmykia',103300),
	(3740,_latin1 0x4E6F766F9A616874696E736B,'RUS','Rostov-na-Donu',101900),
	...
	(3746,_latin1 0x4B696E659A6D61,'RUS','Ivanovo',100000),
	...
	(3754,_latin1 0x42616C619A6F76,'RUS','Saratov',97100),
	...
	(3761,_latin1 0x50759A6B696E,'RUS','Pietari',92900),
	(3762,'Vorkuta','RUS','Komi',92600),
	(3763,'Derbent','RUS','Dagestan',92300),
	(3764,_latin1 0x4B69726F766F2D549A65706574736B,'RUS','Kirov',91600),
	(3765,'Krasnogorsk','RUS','Moskova',91000),
	(3766,'Klin','RUS','Moskova',90000),
	(3767,_latin1 0x549A61696B6F76736B69,'RUS','Perm',90000),
...
INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES ('ABW','Aruba','North America','Caribbean','193',NULL,103000,'78.4','828','793','Aruba','Nonmetropolitan Territory of The Netherlands','Beatrix',129,'AW'),
	...
	('ARM','Armenia','Asia','Middle East','29800',1991,3520000,'66.4','1813','1627','Hajastan','Republic',_latin1 0x526F62657274204B6F749A61726A616E,126,'AM'),
	('ASM','American Samoa','Oceania','Polynesia','199',NULL,68000,'75.1','334',NULL,'Amerika Samoa','US Territory','George W. Bush',54,'AS'),
	('ATA','Antarctica','Antarctica','Antarctica','13120000',NULL,0,NULL,'0',NULL,_latin1 0x96,'Co-administrated','',NULL,'AQ'),
	...
	('BLR','Belarus','Europe','Eastern Europe','207600',1991,10236000,'68','13714',NULL,'Belarus','Republic',_latin1 0x416C6A616B73616E6472204C756B619A656E6B61,3520,'BY'),
	...
	('CIV',_latin1 0x43F4746520649249766F697265,'Africa','Western Africa','322463',1960,14786000,'45.2','11345','10285',_latin1 0x43F4746520649249766F697265,'Republic','Laurent Gbagbo',2814,'CI'),
	...
	('DZA','Algeria','Africa','Northern Africa','2381741',1962,31471000,'69.7','49982','46966',_latin1 0x416C2D4A617A619269722F416C67E9726965,'Republic','Abdelaziz Bouteflika',35,'DZ'),
	...
	('GEO','Georgia','Asia','Middle East','69700',1991,4968000,'64.5','6064','5924','Sakartvelo','Republic',_latin1 0x456475617264208A65766172646E61647A65,905,'GE'),
	...
	('HRV','Croatia','Europe','Southern Europe','56538',1991,4473000,'73.7','20208','19300','Hrvatska','Republic',_latin1 0x8A74697065204D65736963,2409,'HR'),
	...
	('ISR','Israel','Asia','Middle East','21056',1948,6217000,'78.6','97477','98577',_latin1 0x596973726192656C2F4973726192696C,'Republic','Moshe Katzav',1450,'IL'),
	...
	('KOR','South Korea','Asia','Eastern Asia','99434',1948,46844000,'74.4','320749','442544',_latin1 0x54616568616E204D696E9267756B20284E616D68616E29,'Republic','Kim Dae-jung',2331,'KR'),
	...
	('TWN','Taiwan','Asia','Eastern Asia','36188',1945,22256000,'76.4','256254','263451',_latin1 0x549261692D77616E,'Republic','Chen Shui-bian',3263,'TW'),
	...
	('UKR','Ukraine','Europe','Eastern Europe','603700',1991,50456000,'66','42168','49677','Ukrajina','Republic',_latin1 0x4C656F6E6964204B75749A6D61,3426,'UA'),
	...
	('YUG','Yugoslavia','Europe','Southern Europe','102173',1918,10640000,'72.4','17000',NULL,'Jugoslavija','Federal Republic',_latin1 0x566F6A69736C6176204B6F9A74756E696361,1792,'YU'),
...
CREATE TABLE /*!32312 IF NOT EXISTS*/ `countrylanguage` (
  `CountryCode` char(3) NOT NULL default '',
  `Language` char(30) NOT NULL default '',
  `IsOfficial` char(1) NOT NULL default 'F',
  `Percentage` decimal(4,1) NOT NULL default '0.0',
  UNIQUE KEY `CountryLanguage_ix` (`CountryCode`,`Language`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES ('ABW','Dutch','T','5.3'),
	...
	('BOL','Aimará','T','3.2'),
	('BOL','Guaraní','F','0.1'),
	('BOL',_latin1 0x4B65749A7561,'T','8.1'),
	('BOL','Spanish','T','87.7'),
	('BRA','German','F','0.5'),
	...
	('CHN','Dong','F','0.2'),
	('CHN','Hui','F','0.8'),
	('CHN',_latin1 0x4D616E749A75,'F','0.9'),
	('CHN','Miao','F','0.7'),
	('CHN','Mongolian','F','0.4'),
	('CHN','Puyi','F','0.2'),
	('CHN','Tibetan','F','0.4'),
	...
	('DZA','Arabic','T','86'),
	('DZA','Berberi','F','14'),
	('ECU',_latin1 0x4B65749A7561,'F','7'),
	('ECU','Spanish','T','93'),
	('EGY','Arabic','T','98.8'),
	('EGY','Sinaberberi','F','0'),
	('ERI','Afar','F','4.3'),
	...
	('PCN','Pitcairnese','F','0'),
	('PER','Aimará','T','2.3'),
	('PER',_latin1 0x4B65749A7561,'T','16.4'),
	('PER','Spanish','T','79.8'),
	('PHL','Bicol','F','5.7'),
	('PHL','Cebuano','F','23.3'),
